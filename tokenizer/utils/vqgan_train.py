...
from commons.losses.vq_loss import VQLoss
...
from commons.engine.misc import is_main_process, all_reduce_mean, concat_all_gather,get_world_size
...
if __name__ == "__main__":
    ...
    parser.add_argument("--embed-dim", type=int, default=12, help="codebook dimension for queries quantization")
